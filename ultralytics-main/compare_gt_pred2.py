...
# 配置路径（修改为你的路径）
# ==========================
MODEL_PATH = r"E:\AIpractice\detect\car_bolt_detection\ultralytics-main\runs\detect\car_bolt_ECA_DistractorAware\weights\best.pt"
...
OUTPUT_DIR = r"E:\AIpractice\detect\car_bolt_detection\ultralytics-main\runs\DistractorAware"
